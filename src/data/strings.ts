...
export const STR: Record<Locale, Strings> = {
  en: {
    ...
    ringsTitle: 'Three rings, three rhythms', ringsBody: "One for today's habits, one for your weekly ones and one for your monthly ones — so a slow week never erases a good day.",
  ...
  es: {
    ...
    ringsTitle: 'Tres anillos, tres ritmos', ringsBody: 'Uno para los hábitos de hoy, otro para los semanales y otro para los mensuales — una semana floja no borra un buen día.',
  ...
  pt: {
    ...
    ringsTitle: 'Três anéis, três ritmos', ringsBody: 'Um para os hábitos de hoje, outro para os semanais e outro para os mensais — uma semana fraca não apaga um bom dia.',
